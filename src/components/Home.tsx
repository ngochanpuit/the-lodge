            ...
            <div className="w-full md:w-1/2">
              <div className="detail_container">
                <div className="detail-box">
                  ...
                  <p>
                    At Sirat Cafe, we take great pride in the quality and originality of our coffee.
                    We source only the finest coffee beans from around the world, and our expert
                    baristas take care to ensure that each cup is brewed to perfection.
                  </p>
                </div>
                <div className="detail-box">
                ...
                <div className="detail-box">
                  ...
                  <p>
                    At Sirat Cafe, we offer over 15 types of coffee to choose from, so you can find
                    the perfect blend to suit your tastes. From bold espressos to creamy lattes, our
                    expert baristas are dedicated to creating the perfect cup of coffee for you.
                    Come and explore our variety of coffee options today.
                  </p>
                </div>
              </div>
            </div>
